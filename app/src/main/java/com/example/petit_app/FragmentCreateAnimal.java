...
public class FragmentCreateAnimal extends Fragment {
    ...
    EditText namePet, detailAge, petDescription, detailBreed;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        detailAge = (EditText) RootView.findViewById(R.id.detailAge);
        ...
        btn_add_animal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String age = detailAge.getText().toString();
                String type = "Perro";
                String sex = "Macho";
                ...
                String id_owner = "1";
                String picture = "drawable://" + R.drawable.perrito;
